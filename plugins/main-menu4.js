...
const OwnerName = process.env.OWNER_NAME || 'FRONTIER-X-45H A';
...
💡 *_To see more features, use ${usedPrefix}listmenu or ${usedPrefix}help It's like my magic spell book!_* 💡
`
