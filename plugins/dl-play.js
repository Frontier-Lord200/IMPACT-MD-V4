...
let handler = async (m, { conn, text, botname }) => {
  ...
  await m.reply("⏳️ *IMPACT MD Bot Fetching your audio... Please wait...*");
        ...
        if (data.status === 200 || data.success) {
          ...
          await conn.sendMessage(
            m.chat,
            {
              ...
              caption: `*IMPACT V4 DL*
╭═════════════════⊷
║ 🎶 *Title:* ${songData.title}
║ 🎤 *Artist:* ${songData.artist}
║ 🔗 THANK YOU SORRY NO URL TO BE SHARED
╰═════════════════⊷
> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ Impact ᴠ4*`
            },
            { quoted: m }
          );

          await m.reply("📤 *Sending your song as audio...*");
          ...
          await m.reply("📤 *Sending your song as MP3 file...*");
          ...
          await m.reply("✅ *Impact-v4– World-class bot just successfully sent you what you requested! 🎶*");
