...
let handler = async (m, { conn, text }) => {
  ...
  let loadingMsg = await m.reply("⏳ *Impact-bot is searching for your song... Please wait...*");
  ...
  try {
    ...
    let caption = `🎧 *IMPACT Bot - Music Download* 🎶

💙 *Title:* ${songData.title}
👤 *Artist:* ${songData.artist}
🎵 *Status:* ✅ Success
⚒️ *𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 © IMPACT-TEAM*`;
    ...
    m.reply("✅ *IMPACT-v4 Bot successfully delivered your audio! Enjoy 🎶*");
